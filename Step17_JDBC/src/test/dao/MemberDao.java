 ...
 * 
 * 	- DB 에 insert, update, delete, select 작ㅇ버을 대신해 주는 객체를 생성할 클래스 설계하기
 */
public class MemberDao {
	...
	public boolean insert(MemberDto dto) {
		...
		//변화된 rowCount 값을 확인해서 작업의 성공 여부를 리턴해준다.
		if(rowCount >0) {
        	return true;
        }else {
        	return false;
	...
	//회원 한명의 정보를 수정하고 작업의 성공 여부를 리턴해 해주는 메소드
	...
	public List<MemberDto> getList(){
	      ...
	      try {
	         ...
	         while(rs.next()) {
	            //커서가 우치란 곳의 회원정보를 MemberDto 객체에 담기
